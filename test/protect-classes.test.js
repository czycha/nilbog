const checkClasses = async (selector) => {
  ...
  if (classes.shouldAlwaysBe !== undefined) { unorderedMatch(classes.classList, classes.shouldAlwaysBe) }
  if (classes.shouldAlwaysHave !== undefined) { expect(classes.classList).toEqual(expect.arrayContaining(classes.shouldAlwaysHave)) }
  if (classes.shouldNeverHave !== undefined) { expect(classes.classList).not.toEqual(expect.arrayContaining(classes.shouldNeverHave)) }
  return classes
}
