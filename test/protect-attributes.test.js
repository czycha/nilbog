const checkAttrs = async (selector) => {
	...
	if(attrs.shouldAlwaysBeExactly !== undefined)
		expect(attrs.attributes).toEqual(attrs.shouldAlwaysBeExactly)
	if(attrs.shouldAlwaysHave !== undefined)
		expect(Array.from(Object.keys(attrs.attributes))).toEqual(expect.arrayContaining(attrs.shouldAlwaysHave))
	if(attrs.shouldNeverHave !== undefined)
		expect(Array.from(Object.keys(attrs.attributes))).not.toEqual(expect.arrayContaining(attrs.shouldNeverHave))
	if(attrs.shouldAlwaysEqual !== undefined)
		expect(attrs.attributes).toEqual(expect.objectContaining(attrs.shouldAlwaysEqual))
	return attrs
}
